...
export default function XClusiveDeal() {
  ...
  return (
    <CardCarousel
      ...
      title={
        <>
          <span style={{ color: theme.color.XClusiveDeal }}>X</span>
          <span style={{ color: "white" }}>clusive Deal</span>
        </>
      }
      linkColor={"white"}
      backgroundColor={theme.color.XClusiveDealBackground}
    />
  );
}
